...
function ArpApp() {
  ...
  useEffect(() => {
    const worker = new Worker(new URL('../../workers/looper.js', import.meta.url));
    worker.postMessage({
      question:
    ...
    //arpLoop.arp.pattern = [11, 7, 4, 0];
    arpLoop.arp.pattern = [0, 7, undefined, 7, 5, undefined, 4, 4, undefined, -1, undefined, undefined];
